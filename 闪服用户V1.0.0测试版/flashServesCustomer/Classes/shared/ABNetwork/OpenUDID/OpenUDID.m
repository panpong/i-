...
//#define OpenUDIDLog(fmt, ...) ABLog((@"%s [Line %d] " fmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__);
//#define OpenUDIDLog(fmt, ...) ABLog((@"[Line %d] " fmt), __LINE__, ##__VA_ARGS__);
