...
//        dTextIn = [[DESUtility decodeBase64WithString:sTextIn] mutableCopy];
        
        dTextIn = [[NSMutableData alloc] initWithBase64EncodedString:sTextIn options:0];  // ios7自带base64转换方法
    }
    else {
...
//        sResult = [[NSString alloc] initWithData:dResult encoding:NSUTF8StringEncoding]; //[DESUtility encodeBase64WithData:dResult];
        sResult = [dResult base64EncodedStringWithOptions:NSDataBase64Encoding64CharacterLineLength];  // ios7系统自带转base64方法
    }
    return sResult;
}
...
+ (NSString *)encodeBase64WithString:(NSString *)strData {
	return [DESUtility encodeBase64WithData:[strData dataUsingEncoding:NSUTF8StringEncoding]];
}
